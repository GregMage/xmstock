	...
	<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
		...
		<div class="btn-toolbar mb-2 mb-md-0">
			...
			<div class="btn-group mr-2">				
				...
				<select class="form-control form-control-sm" id="statut_filter" onchange="location='viewprice.php?article_id=<{$article_id}>&area_id=<{$area_id}>&sort=ASC&filter='+this.options[this.selectedIndex].value">
