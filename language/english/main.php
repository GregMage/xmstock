...
define('_MA_XMSTOCK_INDEXCONFIG_XMPROD_WARNINGNOTACTIVATE', 'You must activate the use of xmprod in the xmstock module preferences (if you wish to have production management)');
...
define('_MA_XMSTOCK_ERROR_NOARTICLE', 'There is no article, it is necessary to have at least one article!');
...
define('_MA_XMSTOCK_ERROR_NOPRICE', 'No prices in the database');
...
define('_MA_XMSTOCK_ERROR_ONEARTICLE', 'You must have at least one item (no value 0 on the remaining item)');
...
define('_MA_XMSTOCK_ERROR_SIZE', "The size in preference (Max uploaded files size) exceeds the maximum values defined in 'post_max_size' or 'upload_max_filesize' in your configuration in php.ini");
...
define('_MA_XMSTOCK_ERROR_TRANSFER_ST_TO_AR', 'Departure and arrival stocks are identical');
define('_MA_XMSTOCK_ERROR_TRANSFER_OUTPUT', 'You must choose an external <b>or</b> internal recipient. Not both!');
...
define('_MA_XMSTOCK_STOCK_DEL', 'Permanently remove the item from stock');
define('_MA_XMSTOCK_STOCK_DEL_DESC', 'Attention, the item will no longer be in this stock and the price history will be lost!');
define('_MA_XMSTOCK_STOCK_FREE', 'Free service');
...
define('_MA_XMSTOCK_STOCK_MINI', 'Minimum stock');
define('_MA_XMSTOCK_STOCK_MINI_DSC', 'Value that defines the minimum stock (used if it is necessary to track the minimum stock) . Set to 0 to not track');
define('_MA_XMSTOCK_STOCK_ML', 'Linear (mml)');
define('_MA_XMSTOCK_STOCK_ML_DESC', 'Length in mm');
define('_MA_XMSTOCK_STOCK_ORDER_DESC', 'This option allows you to disable the command');
define('_MA_XMSTOCK_STOCK_SURFACE', 'Surface (mm²)');
define('_MA_XMSTOCK_STOCK_TYPE', 'Type' );
define('_MA_XMSTOCK_STOCK_TYPE_DESC', 'The linear option (mml) is used for material stored in the form of a linear profile.<br>The borrow option allows you to activate the item loan system .');
define('_MA_XMSTOCK_STOCK_STANDARD', 'Standard (Qty)');
...
define('_MA_XMSTOCK_TRANSFER_ARAREA', 'Stock destination');
...
define('_MA_XMSTOCK_TRANSFER_LIST_WARNING', 'Transfers awaiting validation');
define('_MA_XMSTOCK_TRANSFER_LOAN', 'Create a loan');
define('_MA_XMSTOCK_TRANSFER_LOCATION', 'Location') ;
define('_MA_XMSTOCK_TRANSFER_LOCATION_DSC', 'Location of the item in the stock');
define('_MA_XMSTOCK_TRANSFER_NEEDSYEAR', 'Period of need');
define('_MA_XMSTOCK_TRANSFER_NEEDSYEAR_DSC', 'This item is in the production plan, you must indicate for which period your need is');
...
define('_MA_XMSTOCK_TRANSFER_PRICE_DSC', 'Specify the price of the batch to be transferred. A value of 0 will not record a price (if a price already exists in stock, it will be used)');
...
define('_MA_XMSTOCK_TRANSFER_USER', 'Transfer author');
...
define('_MA_XMSTOCK_CHECKOUT_SEND', 'Command sent');
...
define('_MA_XMSTOCK_CADDY_ERROR_NOORDER', 'Item cannot be ordered (order restriction is enabled)');
define('_MA_XMSTOCK_CADDY_ERROR_NOPERMISSION', 'You do not have permission to order in this area');
define('_MA_XMSTOCK_CADDY_ERROR_NOLOAN', 'This item cannot be borrowed at the moment!');
define('_MA_XMSTOCK_CADDY_WARNING_AREA', 'Warning, you can order multiple items but only if they are in the same stock.<br>If you want to order the item below, you must make another order');

// order
define('_MA_XMSTOCK_ORDER_ARTICLES', 'Items ordered');
define('_MA_XMSTOCK_ORDER_DATECANCELLATION', 'Cancellation date');
define('_MA_XMSTOCK_ORDER_DATEDELIVERY', 'Expected delivery date');
...
define('_MA_XMSTOCK_ORDER_DATEWITHDRAWAL', 'announced withdrawal date');
...
define('_MA_XMSTOCK_ORDER_STATUS_1', 'Waiting');
define('_MA_XMSTOCK_ORDER_STATUS_2', 'In progress');
define('_MA_XMSTOCK_ORDER_STATUS_3', 'Delivery/collection');
...
define('_MA_XMSTOCK_ORDER_STATUS_TITLE_2', 'Pending Orders');
define('_MA_XMSTOCK_ORDER_STATUS_TITLE_3', 'Orders Ready (Delivery/ withdrawal)');
define('_MA_XMSTOCK_ORDER_STATUS_TITLE_4', 'Orders delivered');
...
define('_MA_XMSTOCK_ACTION_EDIT', 'Editing an order');
define('_MA_XMSTOCK_ACTION_EDITSTOCK', 'Editing a stock');
define('_MA_XMSTOCK_ACTION_INFODELARTICLE', 'Put "0" to delete an item');
...
define('_MA_XMSTOCK_ACTION_SPLIT_DESC', 'The items selected in "Split" will be grouped into a new order. If the "Quantity" is set to 0, the entire quantity of the item will be transferred to a new order. If the "Quantity" does not contain 0, then the quantity entered will remain in this order and the balance will be transferred to the new order');
...
define('_MA_XMSTOCK_ACTION_TRANSFERT_DESC', 'Order of %s with number %s');
define('_MA_XMSTOCK_ACTION_WARNING_STATUS2', 'Once this form is validated, the items will be deducted from the stock!');
define('_MA_XMSTOCK_ACTION_WARNING_STATUS3', 'Once this form is validated, the order will be considered delivered (items delivered or collected).');

// viewprice.php
define('_MA_XMSTOCK_VIEWPRICE_AMOUNT', 'Transferred quantity');
...
define('_MA_XMSTOCK_VIEWPRICE_PRICE', 'Price');
define('_MA_XMSTOCK_VIEWPRICE_PRICECHF', 'Price in CHF');

// loan.php
define('_MA_XMSTOCK_LOAN_ADD', 'Add a loan');
define('_MA_XMSTOCK_LOAN_AMOUNT', 'Amount');
define('_MA_XMSTOCK_LOAN_AREA', 'Stock');
define('_MA_XMSTOCK_LOAN_ARTICLE', 'Item to be loaned');
define('_MA_XMSTOCK_LOAN_DATE', 'Date of the loan');
define('_MA_XMSTOCK_LOAN_EDIT', 'Edit a loan');
define('_MA_XMSTOCK_LOAN_FORM', 'Loan form');
define('_MA_XMSTOCK_LOAN_ARTICLE', 'Loan item');
define('_MA_XMSTOCK_LOAN_LIST', 'Loan list');
...
define('_MA_XMSTOCK_LOAN_TRANSFERT_DESC', 'Loan of %s with number %s');
...
define('_MA_XMSTOCK_OVERDRAFT_NOOVERDRAFT', 'No items below minimum amount');
