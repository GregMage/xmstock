...
define('_MA_XMSTOCK_ERROR_NOARTICLE', 'Il n\'y a pas de composant, il est nécessaire d\'avoir au minimum un composant!');
...
define('_MA_XMSTOCK_ERROR_ONEARTICLE', 'Vous devez avoir au minimum un composant (pas de valeur 0 sur le composant restant)');
...
define('_MA_XMSTOCK_ERROR_SPLIT', 'Vous ne pouvez pas spliter le composant complet (il n\'y a qu\'un composant...)');
...
define('_MA_XMSTOCK_ERROR_TRANSFER_NOARTICLE', 'Le composant sélectionné n\'est pas disponible dans le stock sélectionné');
...
define('_MA_XMSTOCK_STOCK_ARTICLE', 'Composants en stock');
define('_MA_XMSTOCK_STOCK_DEL', 'Supprimer définitivement le composant du stock');
define('_MA_XMSTOCK_STOCK_DEL_DESC', 'Attention, le composant ne sera plus dans ce stock et l\'historique des prix sera perdu!');
...
define('_MA_XMSTOCK_STOCK_TYPE_DESC', 'L\'option linéaire (mml) est utilisée pour de la matière stocké sous forme de profilé linéaire.<br>L\'option emprunt permet d\'activer le système de prêt du composant.<br>L\'option libre service désactive le suivi des quantités.<br>L\'option surface (mm²) est utilisée pour de la matière stocké sous forme de plaque.');
...
define('_MA_XMSTOCK_TRANSFER_ARTICLE', 'Composant à transférer');
...
define('_MA_XMSTOCK_TRANSFER_LOCATION_DSC', 'Emplacement du composant dans le stock');
define('_MA_XMSTOCK_TRANSFER_NEEDSYEAR', 'Période du besoin');
define('_MA_XMSTOCK_TRANSFER_NEEDSYEAR_DSC', 'Ce composant est dans le plan de production, vous devez indiquer pour quelle période est votre besoin');
...
define('_MA_XMSTOCK_PERMISSION_ORDER_DSC', 'Choisissez les groupes qui peuvent commander des composants dans ces zones de stockage');
...
// user
define('_MA_XMSTOCK_AREA_THEREAREARTICLE', 'Il y a <strong>%s</strong> composants dans cette zone de stockage !');
...
define('_MA_XMSTOCK_CHECKOUT_ERRORQTY', 'La quantité demandée pour les composants avec le logo <span class="badge badge-pill badge-danger">Erreur</span> est supérieure à celle disponible en stock. <br>Cela n\'est pas possible dans le cas d\'un emprunt! La quantité a donc été adaptée.');
define('_MA_XMSTOCK_CHECKOUT_INFORMATION', 'Merci de rendre les composants avec le logo <span class="badge badge-pill badge-light">' . _MA_XMSTOCK_STOCK_LOAN . '</span> dans des délais raisonnables');
...
define('_MA_XMSTOCK_CHECKOUT_WARNINGQTY', 'La quantité demandée pour les composants avec le logo <span class="badge badge-pill badge-warning">Avertissement</span> est supérieure à celle disponible en stock. <br>Le délai de livraison pourrait être plus long !');
define('_MA_XMSTOCK_CHECKOUT_WARNINGQTY2', 'Si le composant désiré est en stock mais pas en quantité suffisante et que vous désirez obtenir la quantité en stock avant la totalité, merci de spliter la commande en 2.');
...
define('_MA_XMSTOCK_CADDY_CONTINUE', 'Continuer la sélection de composants');
...
define('_MA_XMSTOCK_CADDY_ITMES', 'Composants');
...
define('_MA_XMSTOCK_CADDY_ERROR_NOORDER', 'Le composant ne peut pas être commandé (la restriction de commande est activée)');
define('_MA_XMSTOCK_CADDY_ERROR_NOPERMISSION', 'Vous n\'êtes pas autorisé à commander dans cette zone de stockage');
define('_MA_XMSTOCK_CADDY_ERROR_NOLOAN', 'Ce composant ne peut pas être emprunter pour le moment!');
define('_MA_XMSTOCK_CADDY_WARNING_AREA', 'Attention, vous pouvez commander plusieurs composants mais uniquement si ils sont dans le même stock.<br>Si vous voulez commander le composant ci dessous, il faut faire une autre commande');

// order
define('_MA_XMSTOCK_ORDER_ARTICLES', 'Composants commandés');
...
define('_MA_XMSTOCK_VIEWORDER_ARTICLE', 'Composant');
...
//action.php
define('_MA_XMSTOCK_ACTION_ARTICLES', 'Composants');
define('_MA_XMSTOCK_ACTION_EDIT', 'Edition d\'une commande');
define('_MA_XMSTOCK_ACTION_EDITSTOCK', 'Edition d\'un stock');
define('_MA_XMSTOCK_ACTION_INFODELARTICLE', 'Mettre "0" pour supprimer un composant');
...
define('_MA_XMSTOCK_ACTION_SPLIT_DESC', 'Les composants sélectionnés dans "Diviser" seront regroupés dans une nouvelle commande. Si la "Quantité" est renseignée à 0, toute la quantité du composant sera transférée dans une nouvelle commande. Si la "Quantité" ne contient pas 0, alors la quantité renseignée restera dans cette commande et le solde sera transféré dans la nouvelle commande');
...
define('_MA_XMSTOCK_ACTION_WARNING_STATUS2', 'Une fois ce formulaire validé, les composants seront décomptés du stock!');
define('_MA_XMSTOCK_ACTION_WARNING_STATUS3', 'Une fois ce formulaire validé, la commande sera considérée comme livrée (composants livrés ou retirés).');
...
define('_MA_XMSTOCK_LOAN_ARTICLE', 'Composant à mettre en prêt');
...
define('_MA_XMSTOCK_LOAN_LARTICLE', 'Composant en prêt');
...
define('_MA_XMSTOCK_OVERDRAFT_ARTICLE', 'Composant');
define('_MA_XMSTOCK_OVERDRAFT_NOOVERDRAFT', 'Pas de composants en dessous du montant minimum');